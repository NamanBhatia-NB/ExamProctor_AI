...
export default function HomePage() {
  ...
  if (!isClient || loading) return <div className="min-h-screen bg-slate-50 flex items-center justify-center text-sm sm:text-base">Loading...</div>;
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
        ...
        <main className="max-w-6xl mx-auto px-4 sm:px-6 py-10 sm:py-16">
          <div className="text-center mb-16 max-w-3xl mx-auto">
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-blue-600 mb-4">ExamProctor AI</h1>
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-slate-800 mb-4">AI-Powered Online Examination System</h2>
            <p className="text-base sm:text-lg md:text-xl text-slate-600 mb-8 px-2">Secure, intelligent proctoring for remote exams with real-time monitoring</p>
            <Link href="/exam/select" className="inline-block px-6 sm:px-8 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition text-base sm:text-lg font-semibold shadow-md">
              Start Exam
            </Link>
          </div>

          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-16">
            <div className="bg-white p-4 sm:p-6 rounded-xl shadow-sm border border-slate-200 hover:shadow-md transition">
